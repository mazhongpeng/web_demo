    ...
    <div class="col-sm-10">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" class="form-inline" action="/studentLiving_demo_war/building?method=search" method="post">
      ...
      <div class="table-responsive">
        ...
        <!-- add框示例（Modal） -->
        <form method="post" action="/studentLiving_demo_war/building?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
        ...
        <!-- update框示例（Modal） -->
        <form method="post" action="/studentLiving_demo_war/building?method=update" class="form-horizontal" style="margin-top: 0px" role="form"
              id="form_data" style="margin: 20px;">
        ...
        <!-- 删除模态框示例（Modal） -->
        <form method="post" action="/studentLiving_demo_war/building?method=delete"
