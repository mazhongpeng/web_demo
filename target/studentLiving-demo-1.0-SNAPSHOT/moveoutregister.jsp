    ...
    <div class="col-sm-10">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form role="form" class="form-inline" action="/studentLiving_demo_war/moveoutregister?method=search" method="post">
      ...
      <div class="table-responsive">
        ...
        <!-- 迁出模态框示例（Modal） -->
        <form method="post" action="/studentLiving_demo_war/moveoutregister?method=moveout"
