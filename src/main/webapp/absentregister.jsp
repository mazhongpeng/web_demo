...
<div class="container-fluid">
  <form method="post" action="/studentLiving_demo_war/absent?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
...
<script>
  $(function(){
    $('#building').change(function(){
      var id = $(this).val();
      $.ajax({
        url:"/studentLiving_demo_war/livingquarters?method=findByBuildingId&buildingId="+id,
        type:"post",
        dataType:"json",
    ...
    $('#dormitory').change(function(){
      var id = $(this).val();
      $.ajax({
        url:"/studentLiving_demo_war/student?method=findByDormitoryId&dormitoryId="+id,
        type:"post",
        dataType:"json",
        success:function (data) {
          var str = '';
