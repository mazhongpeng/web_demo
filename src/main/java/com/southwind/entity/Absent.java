...
public class Absent {
     ...
     public Absent(Integer id, String buildingName, String dormitoryName, String studentName, String reason, String dormitoryAdminName, String createDate) {
          this.id = id;
     ...
     public String toString() {
          return "Absent{" +
                  ...
                  ", dormitoryAdminId=" + dormitoryAdminId +
                  ", reason='" + reason + '\'' +
                  ", dormitoryAdminName='" + dormitoryAdminName + '\'' +
